...
Python 3.11 или новее, только стандартная библиотека. КиберЛенинка работает на любой системе, OpenAlex только на macOS: ключ читается из связки ключей утилитой `security`.
